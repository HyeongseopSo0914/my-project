import argparse
from backend.common.nlu_engine import NLUEngine
from backend.common.train_util import preprocess_data, train_intent_model
from backend.intents import INTENT_HANDLER   # 여기에 각 intent 핸들러 등록되어 있어야 함
from backend.intents import common           # fallback 핸들러
...
def main():
    ...
    if args.preprocess:
        ...
        from backend.common import train_ner
